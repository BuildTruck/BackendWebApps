...
using ProjectsUserDto = BuildTruckBack.Projects.Application.ACL.Services.UserDto;
using SharedUserDto = BuildTruckBack.Users.Application.Internal.OutboundServices.UserDto;
