...
/// <summary>
/// Resource for creating new personnel with image upload support
/// </summary>
public class CreatePersonnelResource
{
    ...
    /// <summary>
    /// Avatar image file for personnel (max 5MB, JPG/PNG/WebP)
    /// </summary>
    ...
    public List<string> GetValidationErrors()
    {
        ...
        if (StartDate.HasValue && StartDate < DateTime.Now.Date.AddYears(-10))
        {
